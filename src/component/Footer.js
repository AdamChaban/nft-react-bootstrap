    ...
    return (
        <div className="footer">
            <div className="links-menu">
                <a className="social-link" href="https://twitter.com/shibabetscasino" target='_blank'>
                ...
                <a className="social-link" href="https://discord.gg/shibabets" target='_blank'>
                ...
                <a className="social-link" href="https://discord.gg/shibabets" target='_blank'>
                    <img src={OpenseaIcon} className='footer-link-icon' />
                </a>
                ...
                <a className="social-link" href="https://discord.gg/shibabets" target='_blank'>
                    <img src={MediumIcon} className='footer-link-icon' />
                </a>
            </div>
